...
class Admin extends Component {
        ...
        return data.map((val) => {
            if(val.id === selectedId){
                return(
                    <TableRow>
                        ...
                        <TableCell>
                            <Input defaultValue={val.age} type='number'innerRef={(age) => this.age = age}/>
                        </TableCell>
                        <TableCell>
                            <Button style={{backgroundColor: 'red'}}onClick={() => this.setState({selectedId: null})}>
                                Cancel
                            </Button>
                            <Button style={{backgroundColor: 'green'}}onClick={() => this.editMovie(val.id)}>
                                Confirm
                            </Button>
                        </TableCell>
                    </TableRow>
            ...
            return(
                <TableRow>
                    ...
                    <TableCell>
                        <Button style={{backgroundColor: 'blue'}} onClick={() => this.setState({selectedId: val.id})}>
                            Edit
                        </Button>
                        <Button style={{backgroundColor: 'red'}} onClick={() => this.deleteMovie(val.id)}>
                            Delete
                        </Button>
                    </TableCell>
                </TableRow>
    ...
    onBtnAddMovie = () => {
        ...
        if(name && director && image && genre && duration && synopsis && casts && age){
    ...
    render() { 
        ...
        return ( 
            <div>
                <Button style={{backgroundColor: 'green'}} onClick={() => this.setState({openModal: true})}>
                    Add Movie
                </Button>
                <Modal isOpen={openModal}>
                    ...
                    <ModalBody>
                      ...
                      <Input type='number' innerRef={(age) => this.age = age}/>
                    </ModalBody>
                    <ModalFooter>
                      <Button style={{backgroundColor: 'blue'}} onClick={() => this.setState({openModal: false})}>Cancel</Button>
                      <Button style={{backgroundColor: 'red'}} onClick={this.onBtnAddMovie}>Confirm</Button>
                    </ModalFooter>
                </Modal>
                <Table>
                    <TableHead>
